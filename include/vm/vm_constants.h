...
#define ARM_TTE_NS_SHIFT            (63)
#define ARM_TTE_NS_MASK             (1uLL << ARM_PTE_PXN_SHIFT)

#define ARM_TTE_BLOCK_OA_MASK       (0xffffffe00000uLL)
#define ARM_PTE_OA_MASK             (0x7ffffffff000uLL)

#define ARM_PTE_ATTRIDX_SHIFT       (2)
#define ARM_PTE_ATTRIDX_MASK        (3uLL << ARM_PTE_ATTRIDX_SHIFT)

#define ARM_PTE_AF_SHIFT            (10)
#define ARM_PTE_AF_MASK             (1uLL << ARM_PTE_AF_SHIFT)
...
#define ARM_PTE_NS_MASK             (1uLL << ARM_PTE_PXN_SHIFT)
